...
const Contact = () => {
	return (
		<section className="py-6  text-black">
			<div data-aos="fade-up" data-aos-duration="1000" className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
				<Helmet>
					<title>Contact us</title>
				</Helmet>
				<div data-aos="fade-right" data-aos-duration="1200" className="py-6 md:py-0 md:px-6">
				...
				<form data-aos="fade-left" data-aos-duration="1200" noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
